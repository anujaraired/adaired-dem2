                  ...
                  {whatIncluded?.list?.map((card: any, index: number) => (
                    ...
                    >
                      <div className="">
                        ...
                        <p
                          onClick={() => setOpen(!open)}
                          className={`${index === 0 && 'text-[#00769D]'} ${index === 1 && 'text-[#5E8E3E]'} ${index === 2 && 'text-[#D84861]'} ${index === 3 && 'text-[#7D79FD]'} absolute bottom-[2rem] left-[0rem] flex lg:w-fit w-full cursor-pointer items-center justify-center gap-2 lg:left-[2rem] lg:justify-start`}
                        >
