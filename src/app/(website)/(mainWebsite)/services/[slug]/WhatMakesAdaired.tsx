          ...
          {whatMkeDeferent?.list?.map((item: any, idx: number) => {
            ...
            return (
              <div
                ...
                className={`my-[2rem] flex flex-col lg:flex-row justify-between rounded-[20px] p-[2rem] transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} ${isOrange ? 'bg-[#FB9100]/5' : 'bg-[#F9F9F9]'}`}
              >
                ...
                <div className="order-1 lg:order-2 flex w-[100%] justify-end justify-items-end lg:w-[40%]">
