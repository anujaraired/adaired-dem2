            ...
            <MaxWidthWrapper>
                ...
                <div className="grid grid-cols-1 gap-6 pt-[3rem] sm:grid-cols-2 lg:grid-cols-3">
                    {peopleBehindWork?.images?.slice(0, 6).map((card: any, index: number) => (
                        <div
                            key={index}
                            className={`lg:min-h-[586px] md:min-h-[400px] min-h-[400px] relative rounded-3xl overflow-hidden bg-[#FFFFFF] flex items-center justify-center mx-1 my-1 transition-all duration-700 ease-in-out hover:-translate-y-2 hover:shadow-xl hover:duration-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                                }`}
                        >
                            <Image
                                src={card?.img}
                            ...
                            />
                            <div className="absolute lg:bottom-4 md:bottom-2 bottom-2.5 bg-white rounded-2xl w-[95%] max-w-[468px] min-h-[77px]">
                                <div className="flex items-center justify-between p-[1rem]">
                                    ...
                                    <div className="relative w-12 h-12 sm:w-12 sm:h-12 lg:w-[61px] lg:h-[61px] flex-shrink-0">
                                        <Image
                                            src={card?.icon}
