      ...
      {isVarticle ? (
        ...
        <div>
          {isInCenter ? (
            ...
            >
              <div className="md:flex` block w-full lg:w-fit justify-center justify-items-center gap-3 md:justify-center md:justify-items-center lg:justify-start lg:justify-items-start">
                {isLabel && (
