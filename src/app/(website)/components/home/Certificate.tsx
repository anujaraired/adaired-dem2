...
import certificate_2 from '../../../../../public/assets/images/ai/Group 1000006996.svg';
...
import certificate_6 from '../../../../../public/assets/images/ai/Group 1000006995.svg';
...
const Certificate = () => {
  ...
  return (
    <section
      ref={ref}
      className={'bg-[#F9F9F9] py-[3rem] lg:pb-[3rem] lg:pt-[4rem]'}
    >
      {/* viewport */}
      ...
      <MaxWidthWrapper>
        ...
        >
          <Heading
            ...
            headingParts={[
              {
                text: 'Propelling Businesses into the Spotlight through Intelligent AI',
                color: '#000000',
                weight: 700,
              },
            ]}
